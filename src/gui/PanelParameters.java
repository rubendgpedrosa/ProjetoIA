...
public class PanelParameters extends PanelAtributesValue {
    ...
    String[] mutationMethods = {"Insert", "Partial Inversion", "Switch and Shift"};
    ...
    public Mutation<WarehouseIndividual, WarehouseProblemForGA> getMutationMethod() {
        ...
        switch (comboBoxMutationMethods.getSelectedIndex()) {
            ...
            case 1:
                return new MutationPartialInversion<>(mutationProbability);
            case 2:
                return new MutationSwitchAndShift<>(mutationProbability);
        }
        return null;
    }
}
